...
- Handle the remaining two tiles as a pair (tiles 3 and 4)
- Repeat above 2 steps with analogous modifications to fill up the leftmost column (tiles 5, 9 and 13)
